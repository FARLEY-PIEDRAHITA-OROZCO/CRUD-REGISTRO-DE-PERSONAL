        ...
        and !empty($_POST["correo"])){
            ...
            $sql=$conexion->query(
                ...
                if($sql==1){
                    ...
                    echo '<div class="alert alert-danger text-center">Error al registrar persona</div></div>';
                }
    } else{
        echo '<div class="alert alert-warning text-center">Alguno de los campos esta vacio</div></div>';
    };
}
